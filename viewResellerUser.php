...
<div   class="bg_darkgray1"  style="text-align:center;  margin-top:10px; padding-top:  "><h3>
User Details</h3></div>
<a href="changePassword.php?from=reseller"> <img style="padding-left:30px;" src="images/changepassword_button.png" width="30" height="30" /></a><br />
Change Password 
<table BORDER=0 width="100%">
<tr>
	<td colspan="3" align="center">
			<a href="editUser.php?from=reseller"><img src="client/images/edit.png" border="0"></a></td>
  </tr>
<tr>
	<td width="24%"></td>
  <td width="36%"></td>
