...
<div style="width:900px; margin-left:auto; margin-right:auto;">
  <div id="main">
    <div id="mainbutton">
      <table width="100%" border="0" style="background-image:url(images/aboutus.jpg); background-repeat:no-repeat; background-position:right bottom;">
        <tr>
          <td width="1%">&nbsp;</td>
          <td width="84%"><div style="   height: auto; padding-top: 20px;  ">
