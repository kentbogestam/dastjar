   ...
   <div class="center">
      ...
      <form name="register" action="" id="registerform" method="Post" enctype="multipart/form-data">
         ...
         <table   width="100%" border="0" align="center" cellspacing="15">
            ...
            <tr>
               <td width="50%"  class="inner_grid"><b>Description. Max. 50 characters</b><span class='mandatory'>*</span>:</td>
               <td>
                  <INPUT class="text_field_new" type=text name="titleSloganStandDishDescription" id="titleSloganStandDishDescription"  value="<?=$data[0]['product_description']
                     ?>">
                  <div id='error_titleSloganStand' class="error"></div>
               </td>
               <td align="right"><a title="<?=STITLE_TEXT
               ...
               <td colspan="2">
                  <div id="category_lang_div">
                     <div id="linkedCat" name="linkedCat" >
                        <? echo $standardObj->getSingleCategoryList($data[0]['category'],$lang); ?>                     
                     </div>
                  </div>
               </td>
            </tr>
        ...
        <!--  <div class="redwhitebutton_small123">Add your Coupon View</div>
         <table  width="100%" border="0" align="center" cellspacing="15">
            <tr align="left">
               ...
               <td width="50%">
                  <img src="<?=$data[0]['large_image']?>" width="180" height="180">        
               </td>
            </tr>
            <tr align="left" >
