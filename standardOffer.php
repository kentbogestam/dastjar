    ...
    <div id="main">
      <div id="mainbutton">
        <table width="100%" cellspacing="10" border="0">
          ...
          <tr>
            <td width="70%" class="redwhitebutton">2 Add Company</td>
          </tr>
          <tr>
            <td class="blackbutton">3 Add Offer</td>
          </tr>
          <tr>
            <td  class="blackbutton_small" style="padding-top: 5px;">Add Standard Offer</td>
          </tr>
          <tr>
            <td >&nbsp;</td>
          </tr>
          <tr>
            <td><table BORDER=0 width="100%" cellspacing="10" >
                <tr>
                  <td width="515">Language: </td>
                  <td width="469"><select style="width:406px; background-color:#e4e3dd;" onchange="getLangImage(this.value);" class="text_field_new" name="lang" id="lang" >
                ...
                <tr>
                  ...
                  <td width="515">Product Name <span class='mandatory'>*</span>: </td>
                  <td><INPUT class="text_field_new" type=text name="titleSloganStand" id="titleSloganStand" maxlength="19" onblur="iconPreview(this.form); getTitleForProduct(this.form);standardPreview(this.form);" value="<?=$_SESSION['post']['titleSloganStand']
                                   ?>">
                   <br/>
                ...
                <tr style="display:none;">
                  ...
                  <td><INPUT class="text_field_new" type=text name="price" id="price">
                  </td>
                ...
                <tr style="display:none">
                  <td colspan="3" align="center" height="20"><strong>
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="79%" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="108" class="mob_title" id="tslogan" style="font-size:9px; text-transform:lowercase;"></td>
        ...
        <table BORDER=0  width="100%" cellspacing="15" >
          <tr>
            ...
            <td width="469"><select style="width:406px; background-color:#e4e3dd;" class="text_field_new"  tabindex="27" id="sponsStand"
                                        name="sponsStand">
      ...
      <table border="0" width="100%">
                <tr>
                    ...
                    <td width="51%" class="blackbutton_small"  style="padding-top: 5px; "> <span style="cursor:pointer;" onclick="showAdvancedSearchStand();">Advanced Options-Optional</span></td>
...
<table width="100%" BORDER=0  id="advancedSearchStand" style="display:inline;"  cellspacing="15">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="50%" class="blackbutton_small"  style="padding-top: 5px; ">Add your Coupon View</td>
            ...
            <table BORDER=0 width="100%" cellspacing="15" >
              ...
              <a title="<?=SPICTURE_TEXT?>" class="vtip"><b><small>?</small></b></a><br/>
          ...
          <tr>
            <td>&nbsp;</td>
            <td></td>
            <td><INPUT class="text_field_new" type="hidden" name="productName" value="<?=$_SESSION['post']['productName']
                                   ?>" id="productName">
          ...
          <tr>
            <td>&nbsp;</td>
            <td><input type="checkbox" name="publicProduct" id="publicProduct"
                        <?
        ...
        <tr>
          <table width="100%">
            <tr>
              <td width="51%" class="blackbutton_small"  style="padding-top: 5px; "><span style="cursor:pointer;" onclick="showAdvancedInfoPageStnad();">Add your Info Page</span></td>
            </tr>
          </table>
        </tr>
        <tr>
          <td width="100%"><table width="100%" BORDER=0 cellspacing="15"  id="infopageStand" style="display:none;">
              <tr>
                <td width="4">&nbsp;</td>
                <td width="515">Link: </td>
                <td width="469" valign="middle"><TEXTAREA class="text_field_new"name="link" id="link" value="<?=$_SESSION['post']['link']
                                   ?>" ></TEXTAREA>
        ...
        <tr>
          ...
          <td align="center"><table width="200" align="center" border="0" cellpadding="0" cellspacing="0" style="background-image:url(client/images/iphone_large.png); width:270px; height:529px; background-repeat:no-repeat;">
              ...
              <tr>
                ...
                <td valign="top" style="text-align:center; " width="228"><div id="pic_upload" style="width:220px; height:112px;"><img id="picImg" src="upload/coupon/<?=$_SESSION['preview']['large_image']
