   ...
   <div class="center">
      ...
      <div id="container">
         <table width="900"  cellspacing="0" cellpadding="0">
            <tr>
               <td valign="top" >
  <table height="589"   cellpadding="0" cellspacing="0">
     <tr>
                 ...
                 <td colspan="2" align="center">
                    <form action="" name="searchbox" method="get">
                       ...
                       <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                             <td width="24%">&nbsp;</td>
                             <td  align="right" width="455">
                                <table width="100%"  align="center" cellpadding="0" cellspacing="0" class="border2">
                                   <tr>
                                   ...
                                   <tr>
                                      ...
                                      <td width="80%" align="left" valign="middle" bgcolor="#d6d5ce">
                             ...
                             <td width="24%" align="left" valign="top">
                                <div align="center" class="main_bg"  ><a onClick="checkStatus('createCampaign.php')" href="#"  >ADD CAMPAIGN OFFER</a></div>
                             </td>
                          </tr>
                       </table>
                    </form>
                          ...
                          <tr bgcolor="#FFFFFF" >
                             ...
                             <td align="center" valign="middle" class="bg_lightgray" >
                                <table border="0" align="center" cellpadding="0" cellspacing="0">
                                   <tr>
                                      <td>
                                         <div class="action-btn1"><a href="viewCampaign.php?campaignId=<?=$data1['campaign_id'];
                                            ?>" class="a2" title="View"><img src="lib/grid/images/view.gif" width="11" height="11"></a></div>
                                         <div class="action-btn1"><a href="editCampaign.php?campaignId=<?=$data1['campaign_id'];
                                            ?>" class="a2" title="Edit"> <img src="lib/grid/images/edite.gif" width="15" height="15"></a></div>
                                         <div class="action-btn1"><a href="<?=BASE_URL . 'addStore.php?campaignId=' . $data1['campaign_id']?>" class="a2" title="Add Location"> <img src="lib/grid/images/active.gif" width="14" height="12"></a></div>
                                         <div class="action-btn1"><a href="<?=BASE_URL . 'inviteRetailersCamp.php?campaignId=' . $data1['campaign_id']?>" class="a2" title="Mail To Retailers"> <img src="lib/grid/images/deactive.gif" width="14" height="12"></a></div>
                                         <div class="action-btn1"><a href="javascript:delete_rec('campaignId=<?=$data1['campaign_id']; ?>')" onClick="" class="a2" title="Delete"><img src="lib/grid/images/delete.gif" width="11" height="11"></a></div>
                                         <div class="action-btn2"><a href="<?=BASE_URL . 'addLanguage.php?campaignId=' . $data1['campaign_id']?>" class="a2" title="Add Language"> <img src="lib/grid/images/lang.png" width="16" height="16"></a></div>
                                      </td>
                                   </tr>
                                </table>
                             </td>
