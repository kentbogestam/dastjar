...
<script language="JavaScript" src="client/js/jsResellerRegistration.js" type="text/javascript"></script>
<div class="center">
<div align="center">
    <form name="register" action="" id="registerform" method="POst">
        ...
        <input type="hidden" name="m" value="saveregseller">
        <table width="100%">
            <tr>

                <td width="70%"><table width="100%" BORDER=0 cellspacing="10"  >
<!--<tr>
<td>Role</td>
<td><select name="role" id="role" style="width: 200px;">
    ...
    <option value="Saller">Saller</option>
                        ...
                        <tr>
                            ...
                            <td width="50%" align="left">Enter e-mail address to be used as user name <span class='mandatory'>*</span></td>
            ...
            <td align="left">
                <select class="text_field_new" style="width:406px; background-color:#e4e3dd;"  tabindex="27" id="cprefix" name="cprefix">
			...
			<tr>
                ...
                <td align="left">Street<span class='mandatory'>*</span></td>
                <td align="left">
                    <INPUT class="text_field_new" type=text name="street_addr" id="street_addr" value="<?=$_SESSION['post']['street_addr'] ?>">
                    <div id='error_street_addr' class="error"></div></td>
            </tr>			
			...
			<tr>
                ...
                <td align="left">
                    <INPUT class="text_field_new" type=text name="city_addr" id="city_addr" value="<?=$_SESSION['post']['city_addr'] ?>">
                    <div id='error_city_addr' class="error"></div></td>
            </tr>	
			
			<tr>
                
                <td align="left">Zip<span class='mandatory'>*</span></td>
                <td align="left">
                    <INPUT class="text_field_new" type=text name="home_zip" id="home_zip" value="<?=$_SESSION['post']['home_zip'] ?>">
                    <div id='error_home_zip' class="error"></div></td>
            </tr>	
			...
			<tr>
                ...
                <td align="left">Social number<span class='mandatory'>*</span></td>
                <td align="left">
                    <INPUT class="text_field_new" type=text name="social_number" id="social_number" value="<?=$_SESSION['post']['social_number'] ?>">
                    <div id='error_social_number' class="error"></div></td>
            </tr>

			
			<tr>
                
                <td align="left">Bank account number<span class='mandatory'>*</span></td>
                <td align="left">
                    <INPUT class="text_field_new" type=text name="resellers_bank" id="resellers_bank" value="<?=$_SESSION['post']['resellers_bank'] ?>">
                    <div id='error_resellers_bank' class="error"></div></td>
            </tr>
...
<!-- <div id="error_recaptcha" class="error">-->
            ...
            <th height="50" colspan ="3" align="center" class="newstyletext"><input type="checkbox" name="terms" id="terms">I am older then 18 years and I understands that I am personally responsible for paying any taxes that are the result of income from Dastjar.
            ...
            <tr align="center">
                <td height="32" colspan='3' align="left" class="redgraybutton">2 Add Offer</td>
            </tr>
            <tr>
                <td height="15" colspan='3' >&nbsp;</td>
            </tr>
