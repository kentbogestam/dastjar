...
<? if($reseller == '') { ?>
                         ...
                         <a href="editStoreStandard.php?storeId=<?=$data1['storeDetails']['store_id'];
            ?>&productId=<?=$productid?>" class="a2" title="Edit"> <img src="lib/grid/images/edite.gif" width="15" height="15"></a></td>
        <? } ?>
        </tr>
    ...
    function langChange(lang,prodId,reseller)
{
    if(reseller =='')
        {
    javascript:location.href = "viewStandard.php?lang="+lang+"&productId="+prodId;
        }else {
            javascript:location.href = "viewStandard.php?lang="+lang+"&productId="+prodId+"&from="+reseller;
        }
}
</script>
