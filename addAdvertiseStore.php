<?php
/*
*   File Name   : addAdvertiseStore.php
*   Description : add Advertise Store Form
...
if ($_SESSION['userid']) {
    ...
    $checkData = $storeObj->getAllSelecterPrivateAdvertiseLocation($advertiseid);
} 
else {
...
if (isset($_POST['continue'])) {
    $storeObj->savePrivateAdvertiseLocation($advertiseid);
}
?>
...
?>" />
                ...
                ?>" /></td>
                                                                ...
                                                                <td width="72%" align="left" class='bg_lightgray'><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="100%" align="left" style="padding-left:15px;">
                                                                                ...
                                                                                <a href="addAdvertiseStore.php?advertiseId=<?= $advertiseid; ?>"><strong>View All</strong></a>
                                                    ...
                                                    <td width="24%" valign="top"><div align="right"  ><a href="newCreateStore.php" >ADD NEW LOCATION</a><br>
                                                            <a href="createPublicLocation.php?advertiseId=<?= $advertiseid; ?>" >ADD PUBLIC LOCATION</a>
                                                        </div></td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%" border="0" cellpadding="6" cellspacing="0" class="border">
                                                <tr>
                                                    <td width="49%" align="left"><input type="text" id="paging_val" name="paging" value="<? echo $records_per_page; ?>" style="width:40px"/>  <input type="button" name="paging" value="Show" onClick="paging_manual('<? echo $advertiseid; ?>');"/></td>
    ...
    ?>
                                            ...
                                            <div><input type="submit" name="continue" value="Continue" class="button"/>
                                                <INPUT type="button" value="Back" name="continue1" id="continue1" class="button" onClick="javascript:location.href='showAdvertise.php'" >
                                            </div>
...
<script>
    ...
    function paging_manual(advtID)
    {

        var pag_val = $('#paging_val').val();

        if($('#paging_val').val() == "") {
            javascript:location.href = "addAdvertiseStore.php?advertiseId="+advtID;
        }
        else{
            ...
            if(!intRegex.test(value)) {
                ...
                javascript:location.href = "addAdvertiseStore.php?advertiseId="+advtID+'&pag='+pag_val;
            }
        }
    }
