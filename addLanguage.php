...
<tr>
        ...
        <td colspan="2" >
            <INPUT class="text_field_new" type=text name="titleSlogan" id="titleSlogan" onBlur="iconPreview(this.form);limitPreview(this.form);" value="<?=$data[0]['slogan'] ?>">
        ...
        <td>
            <INPUT class="text_field_new" type=text name="subSlogan" id="subSlogan" onBlur="iconPreview(this.form);limitPreview(this.form);" value="<?=$data[0]['subslogen']
                           ?>">
