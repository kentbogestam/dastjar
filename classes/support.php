...
function searchAllCampaign($paging_limit=0,$uId) {
     ...
     function permanentDeleteCampaign($campaignId,$uId){
        ...
        //////////////////// delete campaign
            ...
            $res2 = mysqli_query($query2) or die('1' . mysqli_error());//die();
            ...
            $res4 = mysqli_query($_SQL4) or die(mysqli_error());
           ...
           // system ("/usr/local/bin/cumbari_s3del.sh $file ");
            ...
            $res7 = mysqli_query($_SQL7) or die(mysqli_error());
            }
            ...
            $res10 = mysqli_query($_SQL10) or die(mysqli_error());
            }
            ...
            $res13 = mysqli_query($_SQL13) or die(mysqli_error());

            }


        $query14 = "select * from c_s_rel  where campaign_id = '" . $campaignId . "'";
        $res14 = mysqli_query($query14) or die(mysqli_error());
     ...
     /////////// delete coupon
             $query15 = "DELETE FROM coupon WHERE coupon_id = '".$couponId."'";
                    $res15 = mysqli_query($query15) or die(mysqli_error());

                    $query16 = "select * from coupon_limit_period_list  where coupon = '" . $couponId . "'";
                    $res16 = mysqli_query($query16) or die('1' . mysqli_error());
                    ...
                    $res17 = mysqli_query($_SQL17) or die(mysqli_error());

                    $_SQL18 = "DELETE FROM limit_period WHERE limit_id = '" . $limitId . "'";
                    $res18 = mysqli_query($_SQL18) or die(mysqli_error());

                    $query19 = "select * from coupon_offer_slogan_lang_list  where coupon = '" . $couponId . "'";
                    $res19 = mysqli_query($query19) or die('1' . mysqli_error());
                    while($rs19 = mysqli_fetch_array($res19))
                 {
                    ...
                    $res26 = mysqli_query($_SQL26) or die(mysqli_error());

                    $_SQL27 = "DELETE FROM lang_text WHERE id = '" . $offslogen . "'";
                    $res27 = mysqli_query($_SQL27) or die(mysqli_error());
                 }


                    $query20 = "select * from coupon_offer_title_lang_list  where coupon = '" . $couponId . "'";
                    $res20 = mysqli_query($query20) or die('1' . mysqli_error());
                    while($rs20 = mysqli_fetch_array($res20))
                  {
                    ...
                    $res21 = mysqli_query($_SQL21) or die(mysqli_error());

                    $_SQL22 = "DELETE FROM lang_text WHERE id = '" . $offtitle . "'";
                    $res22 = mysqli_query($_SQL22) or die(mysqli_error());
                  }

                     $query23 = "select * from coupon_keywords_lang_list  where coupon = '" . $couponId . "'";
                    $res23 = mysqli_query($query23) or die('1' . mysqli_error());
                    while($rs23 = mysqli_fetch_array($res23))
                  {
                    ...
                    $res24 = mysqli_query($_SQL24) or die(mysqli_error());

                    $_SQL25 = "DELETE FROM lang_text WHERE id = '" . $ckeyword . "'";
                     $res25 = mysqli_query($_SQL25) or die(mysqli_error());
           ...
           $_SQL28 = "DELETE FROM c_s_rel WHERE coupon_id='" . $couponId . "'";
            $res28 = mysqli_query($_SQL28) or die(mysqli_error());
        }
...
function permanentDeleteStandard($productId,$uId){
        ...
        ///////// delete small image and large image
          ...
          $query14 = "DELETE FROM product WHERE product_id = '".$productId."'";
                ...
                $res15 = mysqli_query($query15) or die('1' . mysqli_error());
               while($rs15 = mysqli_fetch_array($res15))
                ...
                $res16 = mysqli_query($_SQL16) or die(mysqli_error());
                ...
                $res18 = mysqli_query($query18) or die('1' . mysqli_error());
                ...
                $res19 = mysqli_query($_SQL19) or die(mysqli_error());

                $_SQL20 = "DELETE FROM lang_text WHERE id = '" . $ckeyword . "'";
                $res20 = mysqli_query($_SQL20) or die(mysqli_error());
                    }

                $query21 = "select * from product_price_list  where product_id = '" . $productId . "'";
                $res21 = mysqli_query($query21) or die('1' . mysqli_error());
...
//////////////// delete coupon
        ...
        while ($rs1 = mysqli_fetch_array($res1)) {
            ...
            if($couponId) {
                ...
                $res4 = mysqli_query($query4) or die('1' . mysqli_error());
               while($rs4 = mysqli_fetch_array($res4))
                ...
                $res5 = mysqli_query($_SQL5) or die(mysqli_error());
                ...
                $res7 = mysqli_query($query7) or die('1' . mysqli_error());
                ...
                $res8 = mysqli_query($_SQL8) or die(mysqli_error());
                ...
                $res10 = mysqli_query($query10) or die('1' . mysqli_error());
                ...
                $res11 = mysqli_query($_SQL11) or die(mysqli_error());
