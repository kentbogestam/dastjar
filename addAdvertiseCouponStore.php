...
<form name="registerform" action="" id="registerform" method="Post" target="_self" enctype="multipart/form-data">
    ...
    <div  class="redwhitebutton" style= " width:452px; margin-left:200px; margin-top: 10px; padding-top: 10px; padding-left: 80px; " onclick="showAdvertiseBehavior()">Enter Coupon Behavior</div>
        ...
        <table BORDER=0 width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a title="<?=ASTART_TEXT ?>" class="vtip"><b><small>see example</small></b></a><br/>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a title="<?=AEND_TEXT ?>" class="vtip"><b><small>see example</small></b></a><br/>
