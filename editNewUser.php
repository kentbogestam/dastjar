...
$accountObj->saveUpdateNewUserDetailById($userid);
}
...
<input type="hidden" name="m" value="">
<div style="height:93px; width:100%; margin-top:20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="93" class="redwhitebutton1234">Update User Details</td>
  </tr>
</table>
</div>
<table width="100%">
...
<td ><table BORDER=0 cellspacing="10" width="100%"  >
<tr>
<td colspan="3" ></td>
</tr>
...
<td width="559" align="left"class="inner_grid">Email Address
		:</td>
<td width="448" align="left"><b/><?=$data[0]['email']?></td>
</tr>
...
<td align="left" width="559">Enter your verification number:</td>
<td align="left">
...
<td align="left"class="inner_grid">Country Prefix:</td>
<td align="left">
<select style="width:406px; background-color:#e4e3dd;" class="text_field_new"  tabindex="27" id="cprefix" name="cprefix">
...
<td align="left">
    <? if($data[0]['mobile_phone'] != 46) { ?>
<INPUT class="text_field_new" type=text name="mob" id="mob"  value="<?=$data[0]['mobile_phone']?>">
<? } else { ?>
<INPUT class="text_field_new" type=text name="mob" id="mob"  value="">
<? } ?>
...
<INPUT type="submit" value="Update " class="button" name="updateUser" id="updateUser">
...
<div align="left"><span  class='mandatory'>* These Fields Are Mandatory </span></div>
</div>
<? include("footer.php"); ?>
