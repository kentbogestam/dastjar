            ...
            <td colspan="0"><table width="100%" border="0" cellspacing="10"   style="display:inline;" id="CampaignBehavior">
                ...
                <tr>
                  ...
                  <td><input class="text_field_new" type="text" name="campaignName" value="<?=$_SESSION['post']['campaignName'] ?>" id="campaignName" />
                    <div id='error_campaignName' class="error" style="display:none"></div></td>
   ...
   <? foreach($discount as $discount1) { ?>
            ...
            <td align="right"><a title="<?=CCODE_TEXTCODE
                ...
                <tr>
                  ...
                  <td><select style="width:406px; background-color:#e4e3dd; border:#abadb3 1px solid" class="text_field_new" name="startDateLimitation" id="startDateLimitation" onBlur="limitPreview(this.form);" value="<?=$_SESSION['post']['startDateLimitation'] ?>">
                ...
                <tr>
                  ...
                  <td><!--<INPUT type=text name="endDateLimitation" id="endDateLimitation">-->
                    <select style="width:406px; background-color:#e4e3dd; border:#abadb3 1px solid" class="text_field_new" name="endDateLimitation" id="endDateLimitation" onBlur="limitPreview(this.form);" value="<?=$_SESSION['post']['endDateLimitation'] ?>">
                ...
                <tr  >
                  <td class="inner_grid" colspan="4"><table width="100%" border="0" align="left" id="ean_table" style="display:none">
                        ...
                        <td width="418" class="inner_grid" id="ean_text" ><input class="text_field_new" type="text" name="etanCode" id="etntext" value="" maxlength="13" onBlur="checkEan(this.value);">
                  ...
                  <table width="100%" border="0" align="left" id="pincode_table" style="display:none">
                        ...
                        <td width="418" class="inner_grid" id="ean_text" ><input class="text_field_new" type="text" name="pinCode" id="pintext" value="" >
                          <div id='error_codes' class="error"></div></td>
                    </table>
                  </td>
                </tr>
        ...
        <table width="100%">
          <tr>
            <td><div class="redwhitebutton_small123" onClick="showExtendedCampaign();">Enter Extended Campaign Offer</div></td>
          </tr>
        </table>
        <table width="100%" BORDER=0 cellspacing="10"  style="display:inline;" id="ExtendedCampaign">
          ...
          <tr>
            ...
            <td valign="middle" ><TEXTAREA class="text_field_new" NAME="descriptive" id="descriptive" COLS=30 ROWS=4><?=$_SESSION['post']['descriptive']
                                    ?>
</TEXTAREA>
