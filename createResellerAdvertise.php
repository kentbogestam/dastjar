...
<div class="center">
  ...
  <div id="main"  >
    <form  name="registerform" action="" id="registerform" method="Post" target="_self" enctype="multipart/form-data" >
      ...
      <input type="hidden" name="m" value="saveNewAdvtOffer">
      <input type="hidden" name="reseller" value="reseller">
      <div id="mainbutton">
        <table width="100%" cellspacing="0" border="0">
          <tr>
            <td class="blackbutton">Add  Advertise Offer</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td class="redwhitebutton_small123"><a href="#"  >Enter Basic Advertise Information</a></td>
          </tr>
        </table>
        ...
        <table  width="100%">
          <tr>
            <td width="90%" align="center"><table BORDER=0  width="100%" class="inner_grid" cellspacing="15">
                ...
                <tr>
                  <td width="531" align="left" class="inner_grid"> Advertise Title. Max. 19 <br />
                ...
                <tr>
                  ...
                  <td align="right" valign="top"><a title="<?=ADESCRIPTION_TEXT
          ...
          <tr>
            <td colspan="0"><table width="100%" border="0" cellspacing="10"   style="display:inline;" id="AdvertiseBehavior">
              ...
              <tr>
                ...
                <td align="right" valign="top"><a title="<?=ASTART_TEXT ?>" class="vtip"><b><small>?</small></b></a> </td>
              </tr>
              <tr>
                ...
                <td align="right" valign="top"><a title="<?=AEND_TEXT ?>" class="vtip"><b><small>?</small></b></a> </td>
              </tr>
              <tr>
                ...
                <td align="right" valign="top"><a title="<?=ADVERTISENAME_TEXT ?>" class="vtip"><b><small>?</small></b></a> </td>
              </tr>
              <tr>
                ...
                <td align="right" valign="top"><a title="<?=AKEYWORD_TEXT ?>" class="vtip"><b><small>?</small></b></a> </td>
              </tr>                           
              <tr>
                <td>&nbsp;</td>
                <td colspan="3">&nbsp;</td>
      ...
      <table width="100%">
        <tr>
          <td align="center"><div class="redwhitebutton_small123" onClick="showExtendedAdvertise();">Enter Extended Advertise Offer</div></td>
        </tr>
      </table>
      <table width="100%" BORDER=0 cellspacing="15"  style="display:inline;" id="ExtendedAdvertise">
        <tr>
          ...
          <tr>
            ...
            <td align="right" valign="top" ><a title="<?=ALINK_TEXT
                                   ?>" class="vtip"><b><small>?</small></b></a></td>
          </tr>
        </table>
        <table width="100%" border="0">
