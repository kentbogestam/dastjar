...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div id="footer">&copy; <?php $firstyr = 2005;
            $nextyr = date('Y');
            if($nextyr <= $firstyr) {
                echo $firstyr;
            }else echo "$firstyr - $nextyr"; ?>, AT Web Results, Inc. - Using 100% W3C Valid <a href="http://validator.w3.org/check?uri=referer">xHTML {STRICT}</a> - <a href="http://jigsaw.w3.org/css-validator/check?uri=referer">CSS</a></div>
