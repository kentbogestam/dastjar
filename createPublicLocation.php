...
if($pag == '')
{
    ...
    $total_records = $storeObj->getAllPublicLocationRows();
   // $total_records;

    $pager = new pager($total_records, $records_per_page, @$_GET['_p']);
    $paging_limit = $pager->get_limit();
    $data = $storeObj->getAllPublicLocation($paging_limit);
   $checkData = $storeObj->getAllSelecterPublicLocation($campaignid);
...
if (isset($_POST['continue'])) {
        $storeObj->savePublicLocation($campaignid);
}
...
function select(a) {
    ...
    for (i=0; i<theForm.elements.length; i++) {
        if (theForm.elements[i].name=='publiclocation[]')
                                                        ...
                                                        <td width="72%" align="left" class='bg_lightgray'><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr>
                                                            ...
                                                            <td width="100%" align="left" style="padding-left:15px;">
                                                                ...
                                                                <a href="createPublicLocation.php?campaignId=<?=$campaignid;?>"><strong>View All</strong></a>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="border" bgcolor="#CCCCCC"  >
                                      <tr align="center" height="26" style="font-weight:bold;">
                                        ...
                                        value='<?=$line['id']
                                           ...
                                           <td align="center"> <input type="checkbox" name="publiclocation[]" id="publiclocation" value="<?=$data1['store_id'];?>"></td>
...
function paging_manual(camid)
{
 ...
 var pag_val = $('#paging_val').val();
  ...
  if($('#paging_val').val() == "") {
      javascript:location.href = "createPublicLocation.php?campaignId="+camid;
    }
    else{
...
javascript:location.href = "createPublicLocation.php?campaignId="+camid+'&pag='+pag_val;
    }
  }
}
