...
<div class="center">
  <form name="register" action="" id="registerform" method="Post" enctype="multipart/form-data">
    <div class="top_h1">View Deleted Advertise Offers</div>
    <div style="clear:both"></div>
    <div class="bg_darkgray123" align="center"> Your Advertise View </div>
    <table width="60%" BORDER=0 align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="50%" align="left" valign="top" class="td_pad_left_2"><b>Title Slogan for your Advertise:</b> </td>
        <td width="50%" align="left" valign="top" class="td_pad_right_2"><?=$data[0]['slogan'] ?></td>
      </tr>
      <tr>
        <td width="50%" align="left" valign="top" class="td_pad_left_2"><b> Sub Slogan for your Advertise:</b> </td>
    ...
    <table width="60%" BORDER=0  align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="50%" class="td_pad_left_2"><b>Advertise Name:</b></td>
        <td width="50%" class="td_pad_right_2"><?=$data[0]['advertise_name'] ?></td>
      </tr>
    </table>
