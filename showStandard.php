...
<td width="14%" class="bg_darkgray1"><strong> Retailers</strong></td>-->
    ...
    <?php
        ...
        echo "<br><a href='";
                                                  ...
                                                  <tr>
                                                    <td><div class="action-btn1"><a href="viewStandard.php?productId=<?=$data1['product_id'];
        ?>" class="a2" title="View"><img src="lib/grid/images/view.gif" width="11" height="11"></a></div><div class="action-btn1"><a href="editStandard.php?productId=<?=$data1['product_id'];
            ?>" class="a2" title="Edit"> <img src="lib/grid/images/edite.gif" width="15" height="15"></a></div><div class="action-btn1"><a href="<?=BASE_URL . 'addStandStore.php?productId=' . $data1['product_id']?>" class="a2" title="Add Location"> <img src="lib/grid/images/active.gif" width="14" height="12"></a></div><div class="action-btn1"><a href="<?=BASE_URL . 'inviteRetailersStand.php?productId=' . $data1['product_id']?>" class="a2" title="Mail To Retailers"> <img src="lib/grid/images/deactive.gif" width="14" height="12"></a></div><div class="action-btn1"><a href="javascript:delete_standard('productId=<?=$data1['product_id']; ?>')" onClick="" class="a2" title="Delete">
                                                    <img src="lib/grid/images/delete.gif" width="11" height="11"></a></div><div class="action-btn2"><a href="<?=BASE_URL . 'addStandLanguage.php?productId=' . $data1['product_id']?>" class="a2" title="Add Language"> <img src="lib/grid/images/lang.png" width="16" height="16"></a></div></td>
                                                  </tr>
                                                  <tr>
                                                    <td></td>
                                                  </tr>
