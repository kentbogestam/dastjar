        ...
        <form method="post" name="myform" action="category_action.php" onSubmit="return confirm_msg();" class="form">
           ...
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="border" bgcolor="#CCCCCC">
              <tr align="center">
                 ...
                 <td width="16%" height="20" align="center"  class="bg_darkgray1"><strong>Plan Nickname</strong></td>
                 <td width="21%" height="20" align="center" class="bg_darkgray1"><strong>Product Name</strong></td>
              ...
              <tr bgcolor="#FFFFFF" style="font-size:18px; font-weight:bold;">
                 ...
                 <td align="center">
                     <table border="0" align="center" cellpadding="0" cellspacing="0">
                       <tr>
                          <td>
                             <div class="action-btn2"><a href="viewBillingCustomer.php?uId=<?=$data1['user_plan_id'];
