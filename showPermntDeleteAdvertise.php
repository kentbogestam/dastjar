...
if ($uId != '') {
    ...
    $total_records = $supportObj->getTotalAdvertise($uId);
    // echo $total_records;
    $pager = new pager($total_records, $records_per_page, @$_GET['_p']);
    $paging_limit = $pager->get_limit();
    $data = $supportObj->getAdvertiseDetails($paging_limit, $uId);
...
if ($case == 'deleteCategory') {
    ...
    $supportObj = new support();
    $supportObj->permanentDeleteAdvertise($advertiseId, $uId);
}
...
<script>
    ...
    {  
        javascript:location.href = "showPermntDeleteAdvertise.php?uId="+uId;
    }

    function deleteAdvertise(camId,uId)
    { 
       
        var answer = confirm('Are you sure you want to delete this Advertise')
        if(answer)
        {
            var url = 'showPermntDeleteAdvertise.php?m=deleteCategory&advertiseId='+camId+'&uId='+uId;
            window.location = url;
        }
...
?>" /></td>
                                            ...
                                            <td width="80%" align="left" valign="middle" bgcolor="#d6d5ce"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td width="100%" align="left" style="padding-left:15px;">
                                                            ...
                                                            <a href='showPermntDeleteAdvertise.php?uId=<? echo $uId; ?>'><strong>View All</strong></a>
                        ...
                        <? } ?>
                                                                         ...
                                                                         <table width="100%" cellpadding="0" cellspacing="2" class="border">
                                                                             ...
                                                                             <tr align="center" height="26" >
                                                                                 ...
                                                                                 <td width="17%" class="bg_darkgray1"><strong>Advertise Name</strong></td>
            ...
            ?>
                ...
                ?>
                                                                                             ...
                                                                                             <td align="center"><strong><a href="viewSupportAdvertise.php?advertiseId=<?=$data1['advertise_id']; ?>&backuid=<?=$uId; ?>" title="view" ><img src="lib/grid/images/view.gif"></a></strong>&nbsp;&nbsp;|&nbsp;&nbsp;<strong><a href="#" title="Delete" onClick="deleteAdvertise('<?=$data1['advertise_id']; ?>','<?=$uId; ?>');"> <img src="lib/grid/images/delete.gif"></a></strong></td>
                                                                                         </tr>
