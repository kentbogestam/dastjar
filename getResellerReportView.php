...
/////////////////////////////
   // $data2 = $reportObj->getReportStoreViewDetails();//store in comment in reseller//
    ///////////////////////////////////////////
...
<link href="client/css/stylesheet123.css" rel="stylesheet" type="text/css" />
    ...
    <body>
    <div class="center">
        <div align="left" style="color:#821a21;"><h2  >Report View</h2></div>
        <div align="left">
            ...
            <!--comment in location in reseller -->
        ...
        <div style="display:none; font-size:16px;" id="report_standard">
            <table border="0" width="100%" cellspacing="1"  bgcolor="#CCCCCC"  >
                ...
                <?php } else {
                ?>
                  <tr bgcolor="#FFFFFF"> <td colspan="5"><?php echo "No Records Found"; ?></td>
                    </tr>
                <?php } ?>
