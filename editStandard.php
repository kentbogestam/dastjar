    ...
    <table  width="100%" border="0" cellspacing="14">
        <tr>
          <td width="515" align="left" valign="top" class="inner_grid">Sponsored Standard Offer<span class='mandatory'>*</span>:</td>
            <td width="469" align="left" valign="top"><select class="text_field_new" style="width:406px; background-color:#e4e3dd;" tabindex="27" id="sponsStand" name="sponsStand"><div id='error_sponsStand' class="error"></div>
                    <option <?=$data[0]['is_sponsored'] <> 1 ? 'selected' : ''
                                ?> value="0">No</option>
          <option <?=$data[0]['is_sponsored'] <> 0 ? 'selected' : ''
                                ?> value="1">Yes</option>
                </select>
          <br> <span style="font-size:12px;"> (Price per view 0.01 kr)</span>          </td>
        </tr>
