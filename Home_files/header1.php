...
<div id="container">
<div id="header">
<div id="logo"><a href="<?=_HOME_?>"><img src="images/logo.png" width="249" height="118" /></a></div>

<div id="nevi">
	<table width="100%" height="100%" cellpadding="0" cellspacing="0">
				<tr>
						<td height="72" align="center" style="font-size:14px; font-weight:bold;"></td>
						<td height="72" colspan="2" align="right" style="font-size:14px; font-weight:bold; font-family:Verdana,Arial,Helvetica,sans-serif;"><?php
...
?></td>
				...
				<tr>
						...
						<td width="24%" id="nevigation_color"><a href="aboutUs.php">About Us</a></td>
						<td width="22%" align="right" id="nevigation_color"><a href="contactus.php">Contact Us</a></td>
				</tr>
		</table>	
</div>
