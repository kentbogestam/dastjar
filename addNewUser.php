...
<div style="clear:both"></div>
    ...
    <table BORDER=0 width="100%" cellspacing="13" >
        <!--<tr>
            <td>Role</td>
        ...
        <tr>
            ...
            <td width="50%" align="left" class="inner_grid">Email Address
            		<span class='mandatory'>*</span>:</td>
            <td width="50%" align="left">
                <INPUT class="text_field_new" type=text name="emailid" id ="emailid"  onblur="checkEmailExist();">
                &nbsp;<a title="<?=EMAIL_TEXT?>" class="vtip" ><b><small>?</small></b></a>
...
&nbsp;                <a title="<?=PASS_TEXT?>" class="vtip"><b><small>?</small></b></a>
        ...
        <tr>
            ...
            <td align="left">
                <INPUT class="text_field_new" type=Password name="c_pwd" id="c_pwd"><div id='error_c_pwd' class="error"></div></td>
           
        </tr>
    <!--    <tr>
        		<td align="left" class="inner_grid">Enter your verification number:</td>
        		<td align="left"><INPUT class="text_field_new" type=text name="verification_code" id="verification_code"><div id='error_verification_code' class="error"></div></td>
        		
        </tr> -->
        <tr>
        		<td align="left" class="inner_grid">First Name<span class='mandatory'>*</span>:</td>
        		<td align="left"> <INPUT class="text_field_new" type=text name="fname" id="fname">
...
<table width="100%" cellspacing="13" border="0">
        ...
        <tr>
            ...
            <td width="50%" align="left" class="inner_grid">Last Name
            		<span class='mandatory'>*</span>:</td>
            <td width="50%" align="left">
                <INPUT class="text_field_new" type=text name="lname" id="lname">
                <div id='error_lname' class="error"></div></td>
        </tr>
        <tr>
        		
            <td width="50%" align="left" class="inner_grid">Country Prefix<span class='mandatory'>*</span>:</td>
        ...
        <tr>
            ...
            <td width="50%" align="left" class="inner_grid">Phone Number<span class='mandatory'>*</span>:</td>
            <td align="left">
                <INPUT class="text_field_new" type=text name="phone" id="phone">
                &nbsp;<a title="<?=PHONE_TEXT?>" class="vtip" ><b><small>?</small></b></a></span>
          <div id='error_phone' class="error"></div></td>
      </tr>
        <tr>
        		
            <td width="50%" align="left" class="inner_grid">Mobile Number<span class='mandatory'>*</span>:</td>
            <td colspan="2" align="left">
...
<table width="100%" >
        ...
        <tr>
            <td colspan='3' align="left" style="padding-left:390px;">
<br />
<br />

                <INPUT style="margin-left:50px;" type="submit" name="Continue" value="Submit" class="button" id="Continue">
                <br />
                <br /></td>
        </tr>
    </table>
