...
<div id="mainbutton"><table width="100%" cellspacing="2" border="0" >
<tr>
    ...
    <table BORDER=0 width="100%" cellspacing="10">
        ...
        <tr>
            ...
            <td>
                ...
                <div id='error_compname' class="error"></div>            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <div id='error_lowlevel' class="error"></div>            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <div id='error_streetadd' class="error"></div>            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <div id='error_zipcode' class="error"></div>            </td>
        </tr>
        <tr>
