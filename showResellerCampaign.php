...
if ($_SESSION['userid']) {
    ...
    $total_records = $offerObj->showCampaignOffersDetailsResellerRows();
//echo $total_records;
...
?>
                                                                        <script> /* askForStore('<?=$_GET['campId']
?>') */ </script>
                                                            <?php
                                                        }
                                                    }
                                                                    ...
                                                                    <td width="75%" align="left" class='bg_lightgray'><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="100%" align="left" style="padding-left:15px;">
                                                                                    ...
                                                                                    ?>
                                                                                                                                 <a href="showResellerCampaign.php?m=showcampoffer"><strong>View All</strong></a>
                                                                                    <?php } else {
                                                                                    ?>
                                                                                                                                 <a href="showResellerCampaign.php"><strong>View All</strong></a>
                                                                                    <?php } ?></td>
                                                                                                                     </tr>
                                                                                                                 </table></td>
                                                                                                         </tr>
                                                                                                 ...
                                                                                                 <td width="24%" align="left" valign="top"><div align="center" class="main_bg"  ><a href="createResellerCampaign.php" >ADD CAMPAIGN OFFER</a></div>
                                                                                                 </td>
                                                                                             </tr>
                                                                                         </table>
                                                                                     </form>
 ...
 ?>
                                                            ...
                                                            <?php if ($_REQUEST['m'] == "showcampoffer") { ?><? } else {
 ?>
...
<? } ?>
                                                                                                                         ...
                                                                                                                         <table width="100%" cellpadding="2" cellspacing="2" class="border" bgcolor="#CCCCCC">
                                                                                                                             <tr align="center" height="26" >
                                                                                                                               ...
                                                                                                                               <td width="4%" height="25" class="bg_darkgray1" align="center"><strong>S.No.</strong></td>-->
                                                                                                                                 ...
                                                                                                                                 <td width="13%" nowrap class="bg_darkgray1">Campaign Name</td>
                                                                         ...
                                                                         <td width="6%" height="25" class="bg_darkgray1" align="center"><strong>Category</strong></td>-->
                                                                                                                                ...
                                                                                                                                <!-- <td width="10%" class="bg_darkgray1"><strong> Keywords</strong></td>-->
...
<? if ($data1['reseller_status'] != 'A') { ?>
                                                                                                            <div class="action-btn1"><a href="editCampaign.php?campaignId=<?=$data1['campaign_id']; ?>&from=reseller" class="a2" title="Edit"> <img src="lib/grid/images/edite.gif"></a></div><div class="action-btn1"><a href="<?=BASE_URL . 'inviteRetailersCamp.php?campaignId=' . $data1['campaign_id'] ?>&from=reseller" class="a2" title="Mail To Retailers"> <img src="lib/grid/images/deactive.gif"></a></div><div class="action-btn1"><a href="javascript:delete_rec('campaignId=<?=$data1['campaign_id']; ?>','reseller=reseller')" onClick="" class="a2" title="Delete">
                                                                                                                    <img src="lib/grid/images/delete.gif"></a></div><div class="action-btn2"><a href="<?=BASE_URL . 'addLanguage.php?campaignId=' . $data1['campaign_id'] ?>&from=reseller" class="a2" title="Add Language"> <img src="lib/grid/images/lang.png"></a></div></td>
                                                    <? } ?>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
...
?>" class="a2" title="View"><img src="lib/grid/images/view.gif"></a>
                                                            &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?=BASE_URL . 'addStore.php?campaignId=' . $is_Public1['campaign_id'];
