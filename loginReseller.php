  ...
  <tr>
    <td height="373" valign="top"><br />
      <form id="submitFrm" name="submitFrm" action="" method="post" >
        <input type="hidden" name="m" value="inReseller">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#e9e9e3">
  <tr>
    <td><table border="0" align="center" bgcolor="#e9e9e3">
          <tr>
            <td height="35" align="center" valign="middle" colspan="2"><strong>RESELLER LOGIN </strong></td>
            </tr>
          <tr>
            <td  align="right" valign="middle">Username :</td>
            <td  align="left" valign="middle"  ><input class="text_field_new" style="width:300px;" type="text" name="username" id="username" size="35"  /></td>
          </tr>
          <tr>
            <td align="right" valign="middle">Password : </td>
            <td align="left" valign="middle" ><input class="text_field_new"  style="width:300px;"  type="password" name="password" id="password"  size="35"  /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="40" colspan="2" align="center" valign="middle"><a id="newcumbari" href='registrationResellerProcess.php'>Become a Cumbari Reseller</a></td>
          </tr>
        </table></td>
  </tr>
</table>
