               ...
               <table width="100%" BORDER="0" cellpadding="0" cellspacing="0">
                  <td width="49%">
                     <table width="100%" cellpadding="0" cellspacing="0" >
                        ...
                        <tr>
                           <td align="left" valign="top" class="td_pad_left">Advertise Code<span class='mandatory'>*</span>:</td>
                           <td align="left" valign="top" class="td_pad_right"><INPUT class="text_field_new" type=text name="advtcode" id ="advtcode" value=""></td>
                        </tr>
                     </table>
                  </td>
               </table>
                     ...
                     <td width="58%">
                        <table BORDER=0 class="table">
                           ...
                           <tr>
                              ...
                              <td width="51%">
                                 <INPUT class="text_field_new" type=text name="mincost" id ="mincost">
                                 <div id='error_mincost' class="error"></div>
                              </td>
                           </tr>
                        </table>
                     </td>
...
<?php
   include("footer.php");
   ?>
>>>>>>> dfb8e617fa3a02fc65ecc8ecfde68fb293082b15
