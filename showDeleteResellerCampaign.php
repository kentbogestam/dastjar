...
if ($_SESSION['userid']) {
    ...
    $total_records = $offerObj->showDeleteCampaignDetailsResellerRows();
    //echo $total_records;
//die();
    $pager = new pager($total_records, $records_per_page, @$_GET['_p']);
    $paging_limit = $pager->get_limit();
    $data = $offerObj->showDeleteResellerCampaign($paging_limit);
...
<?php
                                                                    ...
                                                                    <td width="75%" align="left" class='bg_lightgray'><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      <tr>
                                                                        ...
                                                                        <td width="100%" align="left" style="padding-left:15px;">
                                                                                    ...
                                                                                    <a href="showDeleteResellerCampaign.php"><strong>View All</strong></a>                                                                            </td>
                                                                      </tr>
                                                                    </table></td>
                                                                </tr>
                                                               <!-- <tr>
    ...
    echo 'selected="selected"'; ?> value="0">Inactive</option>
                                                        ...
                                                        <td width="24%" align="left" valign="top"><div align="center" class="main_bg"  ><a href="createResellerCampaign.php" ><strong>ADD CAMPAIGN OFFER</strong></a></div>
                                                        </td>
                                                  </tr>
                                                </table>
                                            </form>
