...
<div  class="redwhitebutton" style= " width:452px; margin-left:200px; margin-top: 10px; padding-top: 10px; padding-left: 80px; " onclick="showCampaignBehavior()">Enter Coupon Behaviour</div>
